...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: cPfYxPfKbAAF/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: CuLyKTTZyGKo/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: mSLapS16nzqT/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__p4R1)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
        ...
        __composite["1"]["path"] = `/hello`;
        __composite["1"]["name"] = "Hello";
        return __composite;
      })()}
      simpleNavTheme={(() => {
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <ph.DataCtxReader>
            {$ctx =>
              true ? (
                <div className={classNames(projectcss.all, sty.freeBox__aCj32)}>
                  <IconIcon
                    className={classNames(projectcss.all, sty.svg__jeQpq)}
                    role={"img"}
                  />
                </div>
              ) : null
      ...
      >
        <ph.DataCtxReader>
          {$ctx =>
            true ? (
              <div className={classNames(projectcss.all, sty.freeBox___1KEiV)}>
                {p.renderPlasmicSlot({
                  defaultContents: (
                    <section
                      className={classNames(projectcss.all, sty.section__wzLCp)}
                    >
                      <h1
                        className={classNames(
                          projectcss.all,
